  ...
  return (
    <section ref={ref} className="py-16 bg-[#FAF7F2]">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-0 border border-[#1B4332]/15 rounded-2xl overflow-hidden bg-white/60 shadow-sm">
          {stats.map((stat, i) => (
            <motion.div
              key={stat.label}
